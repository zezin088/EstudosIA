...
if (isset($_GET['perfil_usuario_id'])) {
    ...
    $sql = "SELECT nome, apelido, foto, banner, biografia, aniversario, favoritos, bio_foto FROM usuarios WHERE id = $usuario_id";
